...
def scrape_indeed_jobs(title: str, location: str):
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            print("Indeed job_seen_beacon:", len(job_cards))
            ...
            for i, job in enumerate(job_cards[:20]):
                try:
                    ...
                    salary_el = (
                        ...
                        or job.query_selector("div.salary-snippet-container")
                    )
                    ...
                    print("Indeed parse error:", inner_error)
